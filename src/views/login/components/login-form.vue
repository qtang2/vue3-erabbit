...
// dont have QC package because using external cdn
// so vue.config.js need to set except qc when packing
// import QC from 'qc'
export default {
  name: 'LoginForm',
  ...
  setup () {
    ...
    // reset form when isMsgLogin changed
