<template>
  <div class="home-category" @mouseleave="categoryId = null">
    ...
    <!-- dialog for recommended items start-->
    <div class="layer">
      <h4>
        {{ currCategory && currCategory.id === "brand" ? "品牌" : "商品" }}推荐
        <small>根据您的购买或浏览记录推荐</small>
      </h4>

      <!-- dialog for recommend goods -->
      <ul
    ...
    <!-- dialog for recommended items end-->
  </div>
</template>
...
export default {
  ...
  setup () {
    ...
    // get current category and its goods
    ...
    // setup better not use async await
    // get brands
    findBrand().then(data => {
