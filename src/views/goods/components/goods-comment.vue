<template>
  <div class="goods-comment">
    <div class="head" v-if="commentInfo">
      <div class="data">
        <p>
          <span>{{ commentInfo.saleCount }}</span
          ><span>人购买</span>
        </p>
        <p>
...
export default {
  ...
  setup () {
    ...
    const reqParams = reactive({
      ...
      hasPicture: null,
      tag: null,
      // two values : praiseCount createTime
      sortField: null
    })
    ...
    const total = ref(0)
    // initial and filter change need to send request
    watch(reqParams, () => {
    ...
    return { commentInfo, currentTagIndex, changeTag, reqParams, changeSort, commentList, formatSpecs, formatNickname, total, changePagerFn }
  }
}
</script>
